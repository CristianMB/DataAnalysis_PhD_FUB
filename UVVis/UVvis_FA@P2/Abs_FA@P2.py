...
data_folders = [
    r'H:\FUBerlin\Measurements\UVVis\AnnikaM\20260430_S1-4_Ox_wet_empty',
]
...
selected_names = [
        ...
        #    "FormicAcid_Water" ,
        #    "Recycled_FormicAcid_Water" ,
 
#            "FormicAcid_Water_WBL",             
#            "Recycled_FormicAcid_Water_WBL" ,

           ## "H2O@NoPo_1hCF_d1" ,
#            "Empty@NoPo_1hCF_d2" ,
            ##"S1BsFA@NoPo_2x1hCF_d1_trusted" ,
            ##"S2BsFA+H2O@NoPo_2x1hCF_d1" ,
            ##"S3TsFA@NoPo_2x1hCF_d1" ,
            ##"S4TsFA@NoPo_2x1hCF_d1" ,
            #"Empty@NoPo_1hCF_d1" ,
...
#selected_spectra = Normalize(selected_spectra, 850, 950, mode="I")
